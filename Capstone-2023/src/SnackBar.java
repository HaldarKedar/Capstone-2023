                      ...
                      implements ActionListener
{
  ...
  public SnackBar()
  {
    ...
    Color brandColor1 = new Color(200, 30, 150); // r, g, b
    Color brandColor2 = new Color(180, 30, 100);
    Color brandColor3 = new Color(160, 30, 50);
    ...
    Color blueGray = new Color(38, 111, 124);
